...
export function Answer() {
  ...
  function initpage() {
    $("#btn-run-code").click(runCodeClicked)
    document.getElementById("scripttoexecute").value="maingatelock.insertKey('Blue');"
    console.log("IntPagage");
  }
  ...
  function runCodeClicked() {
    ...
    var codeToUnlockTheDoor=document.getElementById("scripttoexecute").value;
    console.log(codeToUnlockTheDoor);
    var result = CodeQuest.attemptToUnlockTheDoor(codeToUnlockTheDoor);
    console.log(result);
    //todo: Put errors here for the user
    //document.getElementById("javascript-errors").innerHTML = result;
